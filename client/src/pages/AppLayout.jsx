...
import RoomArea from '../components/chat/RoomArea';
  ...
  <div className="app-layout">
    ...
    <div className="server-rail-panel">
      <div className="server-rail-top">
        ...
        {/* DMs button */}
        <button
          className={`server-icon ${view === 'dms' ? 'active' : ''}`}
          onClick={handleDMs}
    ...
    {/* Left panel — friends or channels */}
    ...
    <div className="main-panel">
      {view === 'dms' ? (
        activeFriend ? <DMArea friend={activeFriend} /> : 
        activeRoom ? <RoomArea room={activeRoom} onLeave={(id) => { setActiveRoom(null); }} /> :
    ...
    {avatarClearedMessage && (
      <WarningModal message={avatarClearedMessage} onClose={() => setAvatarClearedMessage('')} />
    )}
    ...
    {banMessage && (
      <WarningModal message={banMessage} onClose={() => { setBanMessage(''); navigate('/'); }} />
    )}
  </div>
);
}