    ...
    <div className="tos-overlay" onClick={onClose}>
      <div className="tos-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="tos-body">
          <p className="tos-intro">Welcome to NihilisticChat. By using this platform you agree to the following rules.</p>
          ...
          <p className="tos-footer">These terms may be updated at any time. Continued use of NihilisticChat means you accept any changes.</p>
        </div>
