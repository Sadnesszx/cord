    ...
    <div className="tos-overlay" onClick={onClose}>
      <div className="tos-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="tos-body">
          ...
          <h3>1. Who We Are</h3>
          <p>NihilisticChat is a free real-time chat platform. This Privacy Policy explains what data we collect, how we use it, and your rights regarding it.</p>

          <h3>2. Data We Collect</h3>
          <p>When you register and use NihilisticChat, we collect the following information:</p>
          <ul>
          ...
          <p>Your data is used solely to provide the NihilisticChat service, including:</p>
          <ul>
          ...
          <p>NihilisticChat requires users to be at least 13 years old to register. We do not knowingly collect data from children under 13. If you believe a child under 13 has registered, please contact the platform owner.</p>
          ...
          <p>We may update this Privacy Policy from time to time. Continued use of NihilisticChat after changes means you accept the updated policy.</p>
